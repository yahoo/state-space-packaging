...
#
# The copyright pertains tot the packaging and arrangement of the components
# Hyperledger Fabric is licensed to you separately 
# Hyperledger Fabric is licensed to you under the terms of the Apache-2.0 license.
# The LICENSE declaration of Hyperledger Fabric can be found at https://github.com/hyperledger/fabric/blob/release-1.4/LICENSE
...
A peer that runs chaincode must be run in a venue that can support docker.
Docker is hardcoded into the peer code, there is no option for any other container runtime.
...
%pre
# This needs to be %%pre so that it will exist prior to the installation event
# If Recommends user-fabric holds then there all is well; else this idempotent stanza must stand in polyfill
%global username fabric
%global uid 782
%global fullname Hyperledger Fabric
